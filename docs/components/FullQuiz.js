...
export default {
    ...
    methods: {
        ...
        async fetchData() {
            const url = `./data/` + this.$route.params.id + ".json";
            ...
            this.actualIndex = 0;
            this.actualQuestion = this.quiz.questions[this.actualIndex];
            this.actualQuestion.tested = false;
            this.actualQuestion.answerChosen = -1;
        },
    },
    template: `
    <div>
    ...
    <Question :question="actualQuestion" :quiz="quiz"></Question>
